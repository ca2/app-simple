...
namespace app_simple_http
{
   ...
   bool main_document::on_new_document()
   {
      ...
      information() << "app_simple_http::document::on_new_document";
   ...
   bool main_document::on_open_document(const ::payload & payloadFile)
   {
      ...
      information() << "app_simple_http::document::on_open_document";
   ...
   int64_t main_document::increment_reference_count()
   {
   ...
   int64_t main_document::decrement_reference_count()
   {
   ...
   void main_document::network_interface_discovery(::index iItem)
   {
