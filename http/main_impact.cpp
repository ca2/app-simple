...
namespace app_simple_http
{
   ...
   void main_impact::on_create_split_impact()
   {
      ...
      m_peditimpact = host_impact < ::app_simple_http::edit_impact >(0);
      ...
      m_pimpact = host_impact < ::app_simple_http::impact >(1);
      ...
      if (strUrl.is_empty())
      {
         ...
         strUrl = "https://raw.githubusercontent.com/ca2/app/main/README.md";
