...
namespace app_simple_networking_application
{
   ...
   int64_t computer_list2::increment_reference_count(OBJECT_REFERENCE_COUNT_DEBUG_PARAMETERS_DEF)
   {
   ...
   int64_t computer_list2::decrement_reference_count(OBJECT_REFERENCE_COUNT_DEBUG_PARAMETERS_DEF)
   {
   ...
   void computer_list2::install_message_routing(::channel * psender)
   {
      ...
      MESSAGE_LINK(MESSAGE_CREATE,psender,this,&computer_list2::on_message_create);
      MESSAGE_LINK(MESSAGE_DESTROY, psender, this, &computer_list2::on_message_destroy);
   ...
   //void computer_list2::network_interface_discovery(::index iItem)
   //{
