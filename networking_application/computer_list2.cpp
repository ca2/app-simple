...
namespace app_simple_networking_application
{
   ...
   int64_t computer_list2::increment_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEF)
   {
   ...
   int64_t computer_list2::decrement_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEF)
   {
