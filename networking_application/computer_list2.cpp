...
namespace app_simple_networking_application
{
   ...
   long long computer_list2::increment_reference_count()
   {
   ...
   long long computer_list2::decrement_reference_count()
   {
   ...
   void computer_list2::install_message_routing(::channel * psender)
   {
      ...
      USER_MESSAGE_LINK(::user::e_message_create,psender,this,&computer_list2::on_message_create);
      USER_MESSAGE_LINK(::user::e_message_destroy, psender, this, &computer_list2::on_message_destroy);
