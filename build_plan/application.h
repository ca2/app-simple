...
namespace app_simple_build_plan
{
   ...
   class CLASS_DECL_APP_SIMPLE_BUILD_PLAN application :
   ...
   public:
      ...
      virtual ::pointer<impact> create_simple_build_plan_impact(::user::impact * pimpactParent, ::user::impact_data * pimpactdata);
