...
namespace app_simple_build_plan
{
   ...
   void impact::initialize_simple_build_plan(const ::scoped_string & scopedstr)
   {
      ...
      auto playoutMain = create_line_layout(this, e_orientation_vertical);
      ...
      pbuttonSend->m_callbackOnClick = [this](auto, auto, auto)
      {
           ...
           ::file::path pathSend = "G:/application/app-simple/build_plan/edit_build_plan_time_and_status.comma_separated";
           ...
           ::file::path pathSend2 = "G:/application/app-simple/build_plan/edit_build_plan_comment.comma_separated";
      ...
      ::file::path path = "G:/application/app-simple/build_plan/build_plan.comma_separated";

      auto str2aCommaSeparated = file()->as_comma_separated(path);
