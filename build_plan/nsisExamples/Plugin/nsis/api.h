...
// The format is 0xXXXXYYYY where X is the major version and Y is the minor version (make_int(y,x))
...
typedef struct {
  ...
  void (NSISCALL *validate_filename)(::i8 *);
