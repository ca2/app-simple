...
__IMPLEMENT_APPLICATION_RELEASE_TIME(app_simple_build_plan);
IMPLEMENT_APPLICATION_FACTORY(app_simple_build_plan);
...
namespace app_simple_build_plan
{
      ...
      m_textMainTitle(this, "main_title")
   {
      ...
      m_strAppId = "app-simple/build_plan";

      m_strDatabaseAppId = "app-simple/build_plan";

      m_strBaseSupportId = "ca2_flag";

      m_strAppName = "Build Plan";
   ...
   void application::init_instance()
   {
      ...
      m_textAppTitle = __text("text://app-simple/build_plan/app_simple_build_plan/Simple Drawing");

      m_textMainTitle = { "Simple Drawing", ::e_source_sync };

      //set_local_data();

      factory()->add_factory_item <::app_simple_build_plan::document >();
      factory()->add_factory_item <::app_simple_build_plan::frame >();
      factory()->add_factory_item <::app_simple_build_plan::main_frame >();
      factory()->add_factory_item <::user::button_impact >();
      factory()->add_factory_item <::app_simple_build_plan::impact >();
      factory()->add_factory_item <::app_simple_build_plan::tab_impact >();
   ...
   void application::on_request(::request * prequest)
   {
      ...
      informationf("----> finished simple_build_plan::on_request");
   ...
   ::pointer<impact> application::create_simple_build_plan_impact(::user::impact* pimpactParent, ::user::impact_data * pimpactdata)
   {
