...
namespace simple_change_grub_default_entry
{
   ...
   int64_t simple_change_grub_default_entry_002::add_ref(OBJ_REF_DBG_PARAMS_DEF)
   {
   ...
   int64_t simple_change_grub_default_entry_002::dec_ref(OBJ_REF_DBG_PARAMS_DEF)
   {
