...
namespace app_simple_shortcut_amender
{
   ...
   ::i64 form_set_icon::increment_reference_count()
   {
   ...
   ::i64 form_set_icon::decrement_reference_count()
   {
   ...
   void form_set_icon::on_layout(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
