...
namespace app_simple_shortcut_amender
{
   ...
   long long form_set_icon::increment_reference_count()
   {
   ...
   long long form_set_icon::decrement_reference_count()
   {
   ...
   void form_set_icon::on_message_create(::message::message * pmessage)
   {
      ...
      øconstruct_new(m_pstillTarget);

      øconstruct_new(m_peditTarget);
