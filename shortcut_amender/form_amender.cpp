...
namespace app_simple_shortcut_amender
{
   ...
   int64_t form_amender::increment_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEF)
   {
   ...
   int64_t form_amender::decrement_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEF)
   {
