...
namespace app_simple_shortcut_amender
{
   ...
   ::i64 form_reset_icon::increment_reference_count()
   {
   ...
   ::i64 form_reset_icon::decrement_reference_count()
   {
   ...
   void form_reset_icon::install_message_routing(::channel * psender)
   {
      ...
      USER_MESSAGE_LINK(::user::e_message_create, psender, this, &form_reset_icon::on_message_create);
   ...
   void form_reset_icon::handle(::topic * ptopic, ::handler_context * phandlercontext)
   {
