...
namespace app_simple_shortcut_amender
{
   ...
   int64_t form_reset_icon::increment_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEF)
   {
   ...
   int64_t form_reset_icon::decrement_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEF)
   {
