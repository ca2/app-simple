...
namespace app_simple_http_folder_upload
{
   ...
   void impact_netnode_url::handle(::topic * ptopic, ::handler_context * phandlercontext)
   {
   ...
   void impact_netnode_url::install_message_routing(::channel * pchannel)
   {
      ...
      MESSAGE_LINK(e_message_create, pchannel, this, &impact_netnode_url::on_message_create);
