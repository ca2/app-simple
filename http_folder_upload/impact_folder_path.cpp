...
namespace app_simple_http_folder_upload
{
   ...
   void impact_folder_path::handle(::topic * ptopic, ::context * pcontext)
   {
   ...
   void impact_folder_path::install_message_routing(::channel * pchannel)
   {
      ...
      MESSAGE_LINK(MESSAGE_CREATE, pchannel, this, &impact_folder_path::on_message_create);
   ...
   void impact_folder_path::on_message_create(::message::message * pmessage)
   {
      ...
      _001SetText(strFolder, ::e_source_initialize);
