...
namespace app_simple_http_folder_upload
{
   ...
   void incoming_socket_thread::initialize(::particle * pparticle)
   {
      ...
      m_typeIncomingSocket = ::type < ::app_simple_http_folder_upload::incoming_socket >();
      ...
      //   auto strCat = file()->safe_get_string("matter://certificate/localhost.ca2software.com.cat");
...
//      return estatus;
   ...
   //   //pthreadSsl->m_strCat = pcontext->m_papexcontext->defer_process_path(dir()->matter("appinstaller.cat"));
