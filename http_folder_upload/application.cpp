...
namespace app_simple_http_folder_upload
{
   ...
   // __IMPLEMENT_APPLICATION_RELEASE_TIME1(app_simple_http_folder_upload));
   ...
   void application::init_instance()
   {
      ...
      factory()->add_factory_item <::app_simple_http_folder_upload::document >();
      factory()->add_factory_item <::app_simple_http_folder_upload::frame >();
      factory()->add_factory_item <::app_simple_http_folder_upload::main_frame >();
      factory()->add_factory_item <::app_simple_http_folder_upload::tab_impact >();
      factory()->add_factory_item <::app_simple_http_folder_upload::main_document >();
      factory()->add_factory_item <::app_simple_http_folder_upload::impact_path >();
      factory()->add_factory_item <::app_simple_http_folder_upload::impact_folder_path >();
      factory()->add_factory_item <::app_simple_http_folder_upload::impact_netnode_url >();
      factory()->add_factory_item <::app_simple_http_folder_upload::impact_start_button >();
      factory()->add_factory_item <::app_simple_http_folder_upload::main_impact >();

      factory()->add_factory_item <::app_simple_http_folder_upload::document >();
      factory()->add_factory_item <::app_simple_http_folder_upload::impact >();

      factory()->add_factory_item <::app_simple_http_folder_upload::incoming_socket >();
      factory()->add_factory_item <::app_simple_http_folder_upload::socket >();
      ...
      add_impact_system("main", __initialize_new ::user::single_document_template(
                               "main",
                               typeid(::app_simple_http_folder_upload::main_document ),
                               typeid(::app_simple_http_folder_upload::main_frame ),
