...
namespace app_simple_http_folder_upload
{
   ...
   int64_t command_list2::increment_reference_count()
   {
   ...
   int64_t command_list2::decrement_reference_count()
   {
   ...
   void command_list2::install_message_routing(::channel * psender)
   {
      ...
      MESSAGE_LINK(MESSAGE_CREATE, psender, this, &command_list2::on_message_create);
      MESSAGE_LINK(MESSAGE_DESTROY, psender, this, &command_list2::on_message_destroy);
