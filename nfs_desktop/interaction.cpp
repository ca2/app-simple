...
namespace app_simple_nfs_desktop
{
   ...
   void interaction::install_message_routing(::channel * psender)
   {
      ...
      USER_MESSAGE_LINK(::user::e_message_create, psender, this, &interaction::on_message_create);
      USER_MESSAGE_LINK(::user::e_message_destroy, psender, this, &interaction::on_message_destroy);
   ...
   void interaction::_001OnDraw(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
      ...
      pdraw2dgraphics->fill_rectangle(rectangleX, argb(127, 100, 180, 255));
      ...
      for (::collection::index i = 0; i < 40; i++)
      {
         ...
         pdraw2dgraphics->text_out(x, y, strLine);
         y -= 25;
      }
