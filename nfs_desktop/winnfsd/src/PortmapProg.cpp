...
CPortmapProg::CPortmapProg(nfs * pnfs) : CRPCProg(pnfs)
{
...
void CPortmapProg::ProcedureDUMP(void)
{
    ...
    Write(PROG_PORTMAP, 2, NFS_IPPROTO_TCP, PORTMAP_PORT);
    Write(PROG_PORTMAP, 2, NFS_IPPROTO_UDP, PORTMAP_PORT);
    Write(PROG_NFS, 3, NFS_IPPROTO_TCP, NFS_PORT);
    Write(PROG_NFS, 3, NFS_IPPROTO_UDP, NFS_PORT);
    Write(PROG_MOUNT, 3, NFS_IPPROTO_TCP, MOUNT_PORT);
    Write(PROG_MOUNT, 3, NFS_IPPROTO_UDP, MOUNT_PORT);
