...
class CNFS3Prog : public CRPCProg
{
    ...
    bool GetUnstableFileAttributesForNFS(memory_file * pfile, const char * path, wcc_attr * pAttr);
    bool GetUnstableFileAttributesForNFS(memory_file * pfile, const char * path, fattr3 * pAttr);
