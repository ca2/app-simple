...
namespace app_simple_nfs_desktop
{
   ...
   bool main_document::on_new_document()
   {
      ...
      information() << "app_simple_nfs_desktop::document::on_new_document";
   ...
   bool main_document::on_open_document(const ::payload & payloadFile)
   {
      ...
      information() << "app_simple_nfs_desktop::document::on_open_document";
   ...
   ::i64 main_document::increment_reference_count()
   {
   ...
   ::i64 main_document::decrement_reference_count()
   {
