...
namespace app_simple_nanoui_example
{
   ...
   huge_integer main_window::increment_reference_count()
   {
   ...
   huge_integer main_window::decrement_reference_count()
   {
...
//   }
   ...
   void main_window::on_message_create(::message::message * pmessage)
   {
      ...
      m_exampleapplicationa.add(___new ExampleApplication1(this));
      m_exampleapplicationa.add(___new ExampleApplication2(this));
      m_exampleapplicationa.add(___new ExampleApplicationIcons(this));
