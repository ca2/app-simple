/*
    nanoui/widget.h -- Base class of all widgets
...
/**
 * \class Widget widget.h nanoui/widget.h
 *
 * \brief Base class of all widgets.
 *
 * \ref Widget is the base class of all widgets in \c nanoui. It can
...
public:
   ...
   /// Construct a ___new widget with the given parent widget
