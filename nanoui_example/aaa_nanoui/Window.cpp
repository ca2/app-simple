...
//   if (!m_button_panel) {
//      m_button_panel = ___new Widget(this);
//      m_button_panel->set_layout(___new BoxLayout(e_orientation_horizontal, e_alignment_middle, 0, 4));
//   }
...
void Window::_nanoui_to_user(::user::interaction * puserinteraction)
{
   ...
   puserinteraction->constructø(m_pform);
