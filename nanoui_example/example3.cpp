...
//
    // Create nanoui gui
    bool enabled = true;
    FormHelper *gui = memory_new FormHelper(this);
    ...
    gui->add_button("A button", []()
       ...
       ->set_tooltip("Testing a much longer tooltip, that will wrap around to memory_new lines multiple times.");;
