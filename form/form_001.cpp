...
//   }
   ...
   void form_001::install_message_routing(::channel * psender)
   {
      ...
      USER_MESSAGE_LINK(::user::e_message_destroy, psender, this, &form_001::on_message_destroy);
   ...
   void form_001::on_perform_top_down_layout(::draw2d::graphics_pointer & pdraw2dgraphics)
   {

      //::user::form_impact::on_perform_top_down_layout(pdraw2dgraphics);
      ...
      m_pedit->display_child(::f64_rectangle_dimension(iLeft, y, cx, sizeEdit.cy));
      ...
      auto sizeButtonMarginSend = m_pbuttonSend->get_margin(m_pedit->get_style(pdraw2dgraphics));
      ...
      m_pstillReceiver->display_child(::f64_rectangle_dimension(iLeft, y, cx, sizeEdit.cy * 5));
