...
//   }
   ...
   int64_t form::increment_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEF)
   {
   ...
   int64_t form::decrement_reference_count(REFERENCING_DEBUGGING_PARAMETERS_DEF)
   {
