...
__IMPLEMENT_APPLICATION_RELEASE_TIME(app_simple_window_size);
IMPLEMENT_APPLICATION_FACTORY(app_simple_window_size);
...
namespace app_simple_window_size
{
   ...
   application::application()
   {
      ...
      m_strBaseSupportId = "app_simple_window_size";
