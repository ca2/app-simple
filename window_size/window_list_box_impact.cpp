...
namespace app_simple_window_size
{
   ...
   window_list_box_impact::window_list_box_impact()
   {
   ...
   ::i64 window_list_box_impact::increment_reference_count()
   {
   ...
   ::i64 window_list_box_impact::decrement_reference_count()
   {
   ...
   void window_list_box_impact::install_message_routing(::channel * psender)
   {

      ::user::show < ::user::list_box >::install_message_routing(psender);

      USER_MESSAGE_LINK(::user::e_message_create,psender,this,&window_list_box_impact::on_message_create);
      USER_MESSAGE_LINK(::user::e_message_destroy, psender, this, &window_list_box_impact::on_message_destroy);

   }


   void window_list_box_impact::on_message_create(::message::message * pmessage)
   {
   ...
   void window_list_box_impact::update_window_list()
   {

      _synchronous_lock synchronouslock(this->synchronization());

      auto mainwindowa = system()->accessibility()->system_get_main_windows();

      reset_content();

      ::collection::index iIndex = 0;

      for (auto & pmainwindow : mainwindowa)
      {

         ::string strTitle = pmainwindow->get_title();

         if (strTitle.has_character())
         {

            m_mainwindowa.add(pmainwindow);

            add_item(strTitle, iIndex);
   ...
   void window_list_box_impact::on_message_destroy(::message::message * pmessage)
   {

   }


   void window_list_box_impact::handle(::topic * ptopic, ::handler_context * phandlercontext)
   {
   ...
   document * window_list_box_impact::get_document()
   {
   ...
   ::pointer < ::accessibility::main_window> window_list_box_impact::current_main_window()
   {
      ...
      if (iIndex < 0 || iIndex >= m_mainwindowa.size())
      {
      ...
      return m_mainwindowa[iIndex];

   }


   void window_list_box_impact::_001OnClip(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
   ...
   void window_list_box_impact::_001OnDraw(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
...
//
   ...
   void window_list_box_impact::on_layout(::draw2d::graphics_pointer & pdraw2dgraphics)
   {
   ...
   bool window_list_box_impact::on_click(::item * pitem, ::user::mouse * pmouse)
   {
