...
namespace app_simple_window_size
{
   ...
   class CLASS_DECL_APP_SIMPLE_WINDOW_SIZE window_list_box_impact :
   ...
   public:
      ...
      string                           m_strFont1;
      int                              m_iSequence;
      ::pointer_array < ::accessibility::main_window > m_mainwindowa;


      window_list_box_impact();
      ~window_list_box_impact() override;
...
//      // void dump(dump_context & dumpcontext) const override;
      ...
      virtual void update_window_list();

      virtual ::pointer < ::accessibility::main_window> current_main_window();
