...
namespace app_simple_nanogui_example1
{
   ...
   application::application()
   {
      ...
      m_strBaseSupportId = "app_simple_nanogui_example1";
   ...
   void application::init_instance()
   {
      ...
      ::factory::add_factory_item <::app_simple_nanogui_example1::document >();
      //::factory::add_factory_item <::app_simple_nanogui_example1::simple_frame >();
      ::factory::add_factory_item <::app_simple_nanogui_example1::impact >();
      ::factory::add_factory_item <::user::form >();
